...
class EKSGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, EKSResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "eks"
        const val GROUP_DESCRIPTION = "EKS"
