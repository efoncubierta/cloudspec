...
class ELBGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, ELBResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "elb"
        const val GROUP_DESCRIPTION = "ELB"
