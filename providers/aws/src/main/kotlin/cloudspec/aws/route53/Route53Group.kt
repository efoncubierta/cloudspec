...
class Route53Group(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, Route53ResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "route53"
        const val GROUP_DESCRIPTION = "Route 53"
