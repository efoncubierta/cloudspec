...
class CognitoGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, CognitoResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "cognito"
        const val GROUP_DESCRIPTION = "Cognito"
