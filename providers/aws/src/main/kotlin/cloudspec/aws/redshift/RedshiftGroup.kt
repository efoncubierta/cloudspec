 ...
 * #L%
 */
package cloudspec.aws.redshift
...
class RedshiftGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, RedshiftResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "redshift"
        const val GROUP_DESCRIPTION = "Redshift"
