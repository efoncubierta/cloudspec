...
class KinesisGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, KinesisResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "kinesis"
        const val GROUP_DESCRIPTION = "Kinesis"
