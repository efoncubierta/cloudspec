...
class ACMGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, ACMResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "acm"
        const val GROUP_DESCRIPTION = "Certificate Manager"
