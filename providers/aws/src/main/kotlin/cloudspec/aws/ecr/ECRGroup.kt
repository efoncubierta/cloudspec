...
class ECRGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, ECRResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "ecr"
        const val GROUP_DESCRIPTION = "ECR"
