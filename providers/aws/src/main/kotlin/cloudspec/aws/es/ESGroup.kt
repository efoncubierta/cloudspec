...
class ESGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, ESResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "es"
        const val GROUP_DESCRIPTION = "Elasticsearch Service"
