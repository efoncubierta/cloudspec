...
class MQGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, MQResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "mq"
        const val GROUP_DESCRIPTION = "Amazon MQ"
