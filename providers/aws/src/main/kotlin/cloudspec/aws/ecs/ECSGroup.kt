...
class ECSGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, ECSResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "ecs"
        const val GROUP_DESCRIPTION = "ECS"
