...
class LambdaGroup(clientsProvider: IAWSClientsProvider) : AWSGroup {
    override val loaders: Map<ResourceDefRef, LambdaResourceLoader<*>> = emptyMap()
    ...
    companion object {
        const val GROUP_NAME = "lambda"
        const val GROUP_DESCRIPTION = "Lambda"
