...
class EC2ReservedInstancesLoaderTest : EC2LoaderTest() {
    ...
    fun `should load all resources`() {
        ...
        assertEquals(reservedInstancesList.size, resources.unsafeRunSync().size)
    }
    ...
    fun `should not load resource by random id`() {
        ...
        val resourceOpt = loader.byId(emptyList(), reservedInstancesId())
    ...
    fun `should load resource by id`() {
        ...
        val resourceOpt = loader.byId(emptyList(), reservedInstances.reservedInstancesId())
